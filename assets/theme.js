...
(function($){
    ...
    Drawer.prototype = $.extend({}, Drawer.prototype, {
      init: function() {
        ...
        $openBtn.on('click', this.open.bind(this));
         //ADDs ADA for MOBILE MENU DO NOT DELETE
        $openBtn.on('click', function(){ $('#NavDrawer > div > div.drawer__scrollable > ul.mobile-nav.mobile-nav--heading-style > li.mobile-nav__item.appear-animation.appear-delay-2 > a:nth-of-type(1)').focus();
        });
  ...
  theme.QtySelector = (function() {
   ...
   //ADA compliance - DO NOT DELETE
        var menuItems = document.querySelectorAll('.site-nav--has-dropdown');
  
    Array.prototype.forEach.call(menuItems, function(el, i){
        el.querySelector('a').addEventListener("click",  function(event){
            if (this.parentNode.className == "site-nav__item site-nav__expanded-item site-nav--has-dropdown") {
                this.parentNode.className = "site-nav__item site-nav__expanded-item site-nav--has-dropdown is-focused";
                this.setAttribute('aria-expanded', "true");
            } else {
                this.parentNode.className = "site-nav__item site-nav__expanded-item site-nav--has-dropdown";
     ...
     var subMenuItems = document.querySelectorAll('.site-nav__dropdown-link--second-level');
      $(subMenuItems).last().focusout(function(){
          $(this).parents("li.site-nav--has-dropdown").removeClass('is-focused');
          $(this).parents("li.site-nav--has-dropdown").setAttribute('aria-expanded', "false");
      });

     
  //   TRAP FOCUS - ADA compliance - DO NOT DELETE
   $(function trapFocus(element) {
      var element = $('#NavDrawer');
      var focusableEls = element[0].querySelectorAll('a[href]:not([disabled]), button:not([disabled]), textarea:not([disabled]), input[type="text"]:not([disabled]), input[type="radio"]:not([disabled]), input[type="checkbox"]:not([disabled]), select:not([disabled])'),
...
window.onscroll = function() {freeShipping()};

var header = document.getElementById("free_shipping_bar");
